...
internal actual fun PlatformScrollBar(
    ...
    // TODO Scrollbar web implementation
}

@Composable
actual fun rememberScrollbarAdapter(state: ScrollState): ScrollbarAdapter {
    return EmptyScrollbarAdapter
}

@Composable
actual fun rememberScrollbarAdapter(state: LazyListState): ScrollbarAdapter {
    return EmptyScrollbarAdapter
}

@Composable
actual fun rememberScrollbarAdapter(state: LazyGridState): ScrollbarAdapter {
    return EmptyScrollbarAdapter
}
